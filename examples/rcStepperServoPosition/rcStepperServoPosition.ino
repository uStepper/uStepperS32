...
*                This example demonstrates the use of uStepper S32 as an RC servo           *
...
void setup(void){
  ...
  stepper.setControlThreshold(30);				//Adjust the control threshold - here set to 30 microsteps before making corrective action
}
